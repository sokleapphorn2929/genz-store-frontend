      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-2 space-y-4">
            {/* ordered item */}
            <div className="bg-white rounded-xl p-4 md:p-6 border border-stone-200/60 shadow-xs flex flex-col sm:flex-row items-center gap-4 md:gap-6 relative group">
